const form = document.getElementById('isofood-contact-form')
...
if (form) {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch(`${window.isofoodApi.root}contact`, {
        method: 'POST',
      ...
      form.reset()
      form.hidden = true
      const successEl = document.getElementById('isofood-contact-success')
      if (successEl) {
