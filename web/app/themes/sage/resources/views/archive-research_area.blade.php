    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      @while (have_posts()) @php(the_post())
        <a href="{{ get_permalink() }}" class="card block no-underline hover:shadow-md">
          ...
          @endif
          <span class="flex h-12 w-12 items-center justify-center rounded-full bg-brand-50 text-brand-600">{!! \App\research_theme_icon(\App\research_area_icon_key(get_the_title())) !!}</span>
