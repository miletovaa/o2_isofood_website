          ...
          <div class="mt-5 space-y-5">
            @foreach ($collaborators as $collaborator)
              ...
              <div class="card flex flex-col gap-6 sm:flex-row">
                <div class="flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-ink-50">
                  @if (has_post_thumbnail($collaborator))
                    {!! get_the_post_thumbnail($collaborator, 'medium', ['class' => 'h-full w-full object-contain p-3']) !!}
                  @else
